...
class MusicPlayer:
    ...
    # ... (باقي الدوال play_audio_file, play_radio, pause, resume, skip, stop, etc. كما هي في الملف القديم)
    # للاختصار، انسخ الباقي من ملفك القديم (من play_audio_file لحد آخر الملف)
